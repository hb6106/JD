...
function _0x2c2e(_0x1fb84b, _0x4097d9) {
    ...
    return _0x4039b1;
};const jdCookieNode = $[_0x2c2e('‫0', '1^ku')]() ? require(_0x2c2e('‫1', ')F^j')) : '';
const notify = $['isNode']() ? require(_0x2c2e('‫2', ')F^j')) : '';
let cookiesArr = [], cookie = '';
if ($['isNode']()) {
    Object[_0x2c2e('‫3', '4o1W')](jdCookieNode)[_0x2c2e('‮4', '@7Zq')](_0x53dac4 => {
        cookiesArr[_0x2c2e('‫5', '434k')](jdCookieNode[_0x53dac4]);
    });
    if (process[_0x2c2e('‫6', 'gggv')]['JD_DEBUG'] && process[_0x2c2e('‮7', 'nVWs')][_0x2c2e('‫8', 'S]Iu')] === _0x2c2e('‮9', '5GAZ')) console[_0x2c2e('‫a', 'Ip[2')] = () => {
    };
} else {
    cookiesArr = [$[_0x2c2e('‮b', '@7Zq')]('CookieJD'), $['getdata']('CookieJD2'), ...jsonParse($[_0x2c2e('‫c', 'HJ]P')](_0x2c2e('‫d', 'pL5G')) || '[]')[_0x2c2e('‫e', 'RFrx')](_0x4d948f => _0x4d948f[_0x2c2e('‮f', 'nVWs')])]['filter'](_0x22d950 => !!_0x22d950);
}
allMessage = '';
message = '';
$[_0x2c2e('‮10', '2ElI')] = ![];
...
!(async () => {
    ...
    $[_0x2c2e('‫1c', 'Svbj')] = _0x2c2e('‫1d', 'hGVd');
...
async function takePostRequest(_0x4421e9) {
    ...
    switch (_0x4421e9) {
        ...
        case'助力':
            ...
            _0x4f476e = _0x2c2e('‫12c', 'Svbj') + $[_0x2c2e('‫ea', 'kvDT')] + '&pin=' + _0x3fcac4[_0x2c2e('‮12d', '6f]v')](encodeURIComponent, $[_0x2c2e('‫12e', 'S]Iu')]) + '&shareUuid=' + $[_0x2c2e('‮12f', '434k')] + _0x2c2e('‮130', 'KqvI') + $[_0x2c2e('‫3d', '!W2t')];
            break;
        default:
