    ...
    for (let _0x5813c8 = 0; _0x5813c8 < _0x183c5a.length; _0x5813c8++) {
        ...
        if (_0x4a424c.assignmentType === 2) {
            ...
            shareList.push({
                ...
                'encryptAssignmentId': _0x4a424c.encryptAssignmentId,
                'itemId': _0x282818,
                'max': false
            });
        }
    ...
    return new Promise(async _0x5b42bb => {
        const _0x4de18f = {
            'url': 'https://wq.jd.com/user/info/QueryJDUserInfo?sceneval=2', 'headers': {
                ...
                'User-Agent': $.isNode() ? process.env.JD_USER_AGENT ? process.env.JD_USER_AGENT : require(_0x3a2151).USER_AGENT : $.getdata('JDUA') ? $.getdata('JDUA') : 'jdapp;iPhone;9.4.4;14.3;network/4g;Mozilla/5.0 (iPhone; CPU iPhone OS 14_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1'
            }
        };
