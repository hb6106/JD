...
import {zjdH5st, zjdInit} from "./function/zjdtool.js";
import {requireConfig, wait} from "./function/TS_USER_AGENTS";
        ...
        if (index < 7) {
            try {
                ...
                if (res.data.assistStatus === 1) {
                    ...
                    // 没开团
                    res = await api('vvipclub_distributeBean_startAssist', {
                        "activityIdEncrypted": res.data.id,
        ...
        try {
            ...
            for (let code of shareCode) {
                try {
                    ...
                    res = await api('vvipclub_distributeBean_assist', {
                        "activityIdEncrypted": code.activityIdEncrypted,
                        "assistStartRecordId": code.assistStartRecordId,
                        "assistedPinEncrypted": code.assistedPinEncrypted,
                        "channel": "FISSION_BEAN",
