...
def apDoTask(cookie):
    print('开始 玩一玩')
    body = {"linkId": linkId, "taskType": "BROWSE_CHANNEL", "taskId": 454, "channel": 4,
            "itemId": "https%3A%2F%2Fsignfree.jd.com%2F%3FactivityId%3DPiuLvM8vamONsWzC0wqBGQ", "checkVersion": False}
...
def wecat(cookie, amountid, poolBaseId, prizeGroupId, prizeBaseId):
    ...
    body = {"businessSource": "happyDiggerH5Cash",
            "base": {"id": amountid, "business": "happyDigger", "poolBaseId": poolBaseId, "prizeGroupId": prizeGroupId,
                     "prizeBaseId": prizeBaseId, "prizeType": 4}, "linkId": linkId}
